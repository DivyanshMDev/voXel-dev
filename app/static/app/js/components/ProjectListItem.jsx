...
class ProjectListItem extends React.Component {
          ...
          try {
            if (file.status === "error") {
              ...
              if (
                response.success &&
                response.uploaded &&
                response.uploaded[file.upload.filename] === file.size
              ) {
      ...
      if (this.state.upload.files.length > 0) {
        ...
        exifr
          ...
          .then((exif) => {
            ...
            if (dateTime && dateTime.toLocaleDateString)
            ...
            if (!dateTime) {
              if (f.lastModifiedDate)
                dateTime = f.lastModifiedDate.toLocaleDateString();
              else if (f.lastModified)
                dateTime = new Date(f.lastModified).toLocaleDateString();
            }
  ...
  render() {
    ...
    return (
      <li
        className={
          "project-list-wrapper project-list-item list-group-item " +
              ...
              <div className="btn-group">
                ...
                >
                  <li>
                    ...
                    >
                      <img
                        src="/static/app/img/SelectImagesandGCP.png"
                        alt={_("Select Images and GCP")}
                        style={{
                          height: "1em",
                          marginRight: "0.25em",
                          filter:
                            "sepia(1) saturate(3) hue-rotate(200deg) brightness(0.8)",
                        }}
                      />
                      {_(
                  ...
                  <li>
                    ...
                    >
                      <img
                        src="/static/app/img/ImportAssets.png"
                        alt={_("Import Assets")}
                        style={{
                          height: "1em",
                          marginRight: "0.25em",
                      ...
                      />
                      {_(
                        <span style={{ color: "#2563EB" }}>Import Assets</span>
                      )}
                    </a>
                  </li>
                  {this.hasPermission("delete") || data.owned ? (
                    <li>
                      ...
                      >
                        <img
                          src="/static/app/img/Delete.png"
                          alt={
                            data.owned ? _("Delete Project") : _("Hide Project")
                          }
                          style={{
                            height: "1em",
                            marginRight: "0.25em",
